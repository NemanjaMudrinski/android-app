...
public class HomeActivity extends AppCompatActivity implements SkladisteFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            SkladisteFragment ff = SkladisteFragment.newInstance();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if(newConfig.orientation == Configuration.ORIENTATION_PORTRAIT){
            setContentView(R.layout.activity_home);
            getSupportFragmentManager().beginTransaction().add(R.id.portraitFrame, SkladisteFragment.newInstance()).commit();
        }
        else
            setContentView(R.layout.activity_home_landscape);
    }
