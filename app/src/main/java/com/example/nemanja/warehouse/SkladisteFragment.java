package com.example.nemanja.warehouse;
...
public class SkladisteFragment extends Fragment implements View.OnClickListener  {

    private OnFragmentInteractionListener mListener;

    public SkladisteFragment() {
     ...
     */
    public static SkladisteFragment newInstance() {
        SkladisteFragment fragment = new SkladisteFragment();
        return fragment;
    }
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View v = (View) inflater.inflate(R.layout.fragment_skladiste, container, false);
